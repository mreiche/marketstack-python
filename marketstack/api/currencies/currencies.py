...
) -> Optional[Union[ErrorResponse, HTTPValidationError, ResponseListmodelsCurrency]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[ErrorResponse, HTTPValidationError, ResponseListmodelsCurrency]]:
    return Response(
